...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="index.php?page=requestProducts" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-download fa-sm text-white-50"></i> Nueva Solicitud
        </a>
    </div>
    ...
    <div class="row">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col-md-8 mr-2">
                            ...
                            <div class="text-xs font-weight-bold text-secondary text-uppercase mt-2">
                                Sucursal de Destino: <?php echo $nameSucursal; ?>
                            </div>
                        </div>
                        <div class="col mr-2">
                            ...
                            <a href="index.php?page=showPDF&ComandaID=<?php echo $row['ComandaID']; ?>"
                               class="d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1 mb-1">
                                <i class="fas fa-download fa-sm text-white-50"></i> Ver Solicitud
                            </a>
                            <a href="javascript:void(0);" 
                               class="d-sm-inline-block btn btn-sm btn-info shadow-sm mt-1 mb-1 toggle-comanda" 
                               data-comanda-id="<?php echo $row['ComandaID']; ?>">
                                <i class="fas fa-eye fa-sm text-white-50"></i> Ver más
                            </a>
                            <?php if ($row['Status'] === 'Abierto'): ?>
                                <a class="d-sm-inline-block btn btn-sm btn-danger shadow-sm" href="#" 
                                   data-toggle="modal" data-target="#deleteModal_<?php echo $row['ComandaID']; ?>">
                                    <i class="fas fa-trash fa-sm text-white-50"></i> Cancelar Solicitud
                                </a>
                            <?php endif; ?>
                        </div>
                        <div class="col-auto">
        ...
        <div class="comanda-collapse col-12" 
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">¿Estas Seguro de eliminar la comanda?</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Cerrar">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        Presiona <b>"Cancelar Comanda"</b> para eliminarla permanentemente. El stock regresará al inventario.
                    </div>
    ...
    toggleButtons.forEach(button => {
        button.addEventListener("click", function () {
            ...
            document.querySelectorAll(".comanda-collapse").forEach(div => {
                if (div.id !== collapseID) div.style.display = "none";
            });
