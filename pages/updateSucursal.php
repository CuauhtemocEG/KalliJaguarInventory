				...
				<form action="./controllers/updateSucursalController.php" method="POST" class="FormularioAjax" autocomplete="off">
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<input class="form-control" type="text" name="nombreSucursal" maxlength="50" required value="<?php echo $datos['nombre']; ?>">
						</div>
						<div class="form-group col-md-6">
							<label class="font-weight-bold">Dirección:</label>
							<input class="form-control" type="text" name="addressSucursal" maxlength="150" value="<?php echo $datos['direccion']; ?>">
						</div>
					</div>
